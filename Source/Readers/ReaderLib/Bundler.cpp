...
Bundler::BundlingChunk::BundlingChunk(size_t numberOfInputs, Bundler* parent, ChunkIdType chunkId)
...
void Bundler::BundlingChunk::GetSequence(size_t sequenceId, std::vector<SequenceDataPtr>& result)
{
