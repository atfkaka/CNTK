...
namespace CSEvalV2Example
{
    ...
    {
        static void EvaluateUsingNDView()
        {
            // Load the model
            var myFunc = global::Function.LoadModel("z.model"); //"01_OneHidden"
            ...
            // No name defined for the z.model
            var inputVar = argList.FirstOrDefault();
        ...
        static void EvaluateWithoutPreAllocatedOutputMemory()
        {
            // Load the model
        ...
        {
            // EvaluateUsingNDView();
            EvaluateWithoutPreAllocatedOutputMemory();
        }
    }
}
